...
function Footer() {
  return (
    <div className="w-full bg-blue-100">
      <div class="mx-auto max-w-7xl bg-blue-100">
        <div class="grid grid-cols-2 lg:grid-cols-4 2xl:grid-cols-6 gap-8 py-10">
          <div class="col-span-full mb-10 2xl:col-span-2 lg:mb-0 flex items-center flex-col 2xl:items-start">
            <a class="flex justify-center lg:justify-start">
              <img src={photo} className="w-full h-44" />
            </a>
          </div>

          <div class="lg:mx-auto text-left">
            <h4 class="text-lg text-gray-900 font-medium mb-7">Searchenix</h4>
        ...
        <div class="py-7 border-t border-gray-500">
          <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span class="text-sm text-gray-500 ">
              ©<a href="">Searchenix</a> 2025, All rights
              reserved.
            </span>
            <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
              <a
                href=""
                class="w-9 h-9 rounded-full bg-blue-700 flex justify-center items-center hover:bg-blue-900"
              >
                <svg
                  class=" text-white"
                  width="32"
              ...
              <a
                class="w-9 h-9 rounded-full bg-blue-700 flex justify-center items-center hover:bg-blue-900 cursor-pointer"
              >
                <svg
